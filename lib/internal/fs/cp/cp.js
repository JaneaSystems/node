...
function areIdentical(srcStat, destStat) {
  return destStat.ino && destStat.dev && destStat.ino === srcStat.ino &&
    // fs__stat_impl_from_path returns long long when it uses fs__stat_path, but
    // it returns unsigned long when it uses fs__stat_handle. Mask lower 4 bytes
    // to make sure the comparison is correct.
    (0xFFFFFFFFn & destStat.dev) === (0xFFFFFFFFn & srcStat.dev);
}
